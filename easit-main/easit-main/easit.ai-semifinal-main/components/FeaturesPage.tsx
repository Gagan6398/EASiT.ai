        ...
        <div className="bg-[#0f1115] text-gray-200 font-sans min-h-screen flex flex-col selection:bg-[#00F0FF] selection:text-black">
            <header className="border-b border-gray-800 py-5 bg-[#0a0b0e]/90 backdrop-blur-md sticky top-0 z-50">
                <div className="container mx-auto px-6 flex items-center">
                    ...
                    <h1 className="ml-8 text-xl font-bold tracking-tight text-white">Easit.ai Features</h1>
                </div>
            </header>
...
const FeatureCard: React.FC<{ icon: React.ReactNode; title: string; children: React.ReactNode }> = ({ icon, title, children }) => (
    <div className="p-8 rounded-3xl bg-[#12141a] border border-gray-800 hover:border-[#00F0FF]/30 transition-all group shadow-sm">
        <div className="w-12 h-12 rounded-2xl bg-[#00F0FF]/10 flex items-center justify-center text-[#00F0FF] mb-6 group-hover:scale-110 transition-transform">
            {icon}
        </div>
